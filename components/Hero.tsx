...
const Hero = () => {
  return (
    ...
    <div className='container absolute top-[300px] xl:left-[200px] sm:flex sm:flex-col sm:left-[100px] pb-[200px] ' id='About'>
      <div className='heroSection absolute mt-[40px] text-center flex flex-col items-center sm:top-[200px] md:top-[100px] lg:top-[500px] xl:top-[0]'>
      ...
      <div className="img absolute xl:left-[900px] sm:left-0] sm:flex flex sm:-top-[200px] xl:top-[0]">
